/*
 * Definitions for the math namespace.
 */
...
#define MATH_SQRT1_2 0.707106781186547524400844362104849039 // 1/sqrt(2)
#define MATH_2_SQRTPI 1.12837916709551257389615890312154517 // 2/sqrt(pi)
