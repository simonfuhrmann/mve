    ...
    math::Matrix<T, N, N>* rot, T* scale, math::Vector<T, N>* trans)
{
    ...
    std::size_t num_correspondences = p0.size() & p1.size();
    ...
    c0 /= num_correspondences;
    c1 /= num_correspondences;
    ...
    cov /= num_correspondences;
    sigma2 /= num_correspondences;
    ...
    T det = math::matrix_determinant(R);
