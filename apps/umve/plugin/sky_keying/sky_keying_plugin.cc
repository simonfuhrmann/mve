...
/*
 * Both receives the view pointer that SceneManager emits
 * and handles it by calling transformImage() on the view pointer.
 */
void
SkyKeyingPlugin::receiveViewPointer(mve::View::Ptr viewPtr)
{
 ...
 */
void
SkyKeyingPlugin::transformViewPointer(mve::View::Ptr viewPtr) {
    if (viewPtr != NULL)
    {
 ...
 */
void
SkyKeyingPlugin::displayImage(QImage *qImg)
{
    QGraphicsScene *scene = new QGraphicsScene();
