...
TEST(MathFunctionsTest, GaussianTest)
{
    ...
    EXPECT_TRUE(MATH_EPSILON_EQ(gaussian(1.0f, 1.0f),
        0.606530659712633f, 0.00000000000001f));
    EXPECT_TRUE(MATH_EPSILON_EQ(gaussian(-1.0f, 1.0f),
        0.606530659712633f, 0.00000000000001f));
    EXPECT_TRUE(MATH_EPSILON_EQ(gaussian(2.0f, 1.0f),
        0.135335283236613f, 0.00000000000001f));
    EXPECT_TRUE(MATH_EPSILON_EQ(gaussian(-2.0f, 1.0f),
        0.135335283236613f, 0.00000000000001f));

    EXPECT_TRUE(MATH_EPSILON_EQ(gaussian(1.0f, 2.0f),
        0.882496902584595f, 0.00000000000001f));
    EXPECT_TRUE(MATH_EPSILON_EQ(gaussian(-1.0f, 2.0f),
        0.882496902584595f, 0.00000000000001f));
    EXPECT_TRUE(MATH_EPSILON_EQ(gaussian(2.0f, 2.0f),
        0.606530659712633f, 0.00000000000001f));
    EXPECT_TRUE(MATH_EPSILON_EQ(gaussian(-2.0f, 2.0f),
        0.606530659712633f, 0.00000000000001f));
}
